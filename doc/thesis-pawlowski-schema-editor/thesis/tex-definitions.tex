...
\newcommand{\docsubtitle}{Entwicklung eines Datenbankschemaeditors für den Einsatz im Schulunterricht}
\newcommand{\docauthors}{Marco Pawlowski}
\newcommand{\docpdfauthors}{Marco Pawlowski}
