...
\todo[inline]{Wie das Ziel erreicht wird ist nicht Teil der Anforderungsanalyse}
...
\end{minipage}
\todo[inline]{Müsste es dann nicht eine \texttt{ProjectPolicy} sein?}
