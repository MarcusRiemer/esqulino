...
Das Muster der globalen Rolle, welches in Rolify (Sektion \ref{sec: rolify}) implementiert wurde konnte genutzt werden, um zwischen den allgemeinen Zugriffsrechten der Benutzer zu unterscheiden.
