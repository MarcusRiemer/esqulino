...
Sensoren ermöglichen außerdem Verzweigungen, die einen Befehlsblock nur dann ausführen, wenn der angegebene Sensor zu Wahr ausgewertet wird und einen weiteren, optionalen Befehlsblock, wenn der Sensor zu Falsch ausgewertet wird. \TODO{elseif}
...
Desweiteren ist es möglich eigene Prozeduren zu definieren und aufzurufen. \TODO{Parameter} Dies ermöglicht zusätzlich die Nutzung von Rekursion.
...
\TODO{Try Catch für Syntaxfehler}
...
\TODO{Behandlung von Endlosschleifen, Abfangen durch try catch => kein try catch mehr im code möglich}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{gfx/implementation-integration-prototype.png}
