...
Der Drag \& Drop-Editor von Blattwerkzeug \tref{sec:requirements:existing:structure:drag-drop} erzeugt aus den Eingaben des Nutzers einen Syntaxbaum \TDOD{geneauere Beschreibung Syntaxbaum}.
