...
# -*- coding: utf-8 -*-
#
# BlattWerkzeug documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'BlattWerkzeug.tex', 'BlattWerkzeug Documentation',
     'Marcus Riemer', 'manual'),
]
...
man_pages = [
    (master_doc, 'blattwerkzeug', 'BlattWerkzeug Documentation',
     [author], 1)
]
