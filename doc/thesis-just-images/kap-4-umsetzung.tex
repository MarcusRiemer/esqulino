...
\todo[inline,author=mri]{Nein, Services sind dazu da zwischen Komponenten zu kommunizieren. Dabei können sowohl Daten als auch Funktionen geteilt werden.}
...
\todo[inline,author=mri]{Warum gehen ETAGs nicht, wenn das doch trivial ist?}
...
\todo[inline,author=mri]{Beispielbild}
