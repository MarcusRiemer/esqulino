...
\begin{figure}
  ...
  % TODO: Alle Grafiken und Tabellen mit Beschreibungen
  % TODO: Auf jede Grafik / Tabelle aus dem Text verweisen
  \caption{Bildergallerie}
  \label{fig:impl-image-gallery}
\end{figure}

\todo[inline]{TODO: Alle Grafiken und Tabellen mit Beschreibungen}
\todo[inline]{Auf jede Grafik / Tabelle aus dem Text verweise}
