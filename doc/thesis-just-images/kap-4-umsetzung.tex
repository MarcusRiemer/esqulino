...
\begin{figure}
  \centering
  \includegraphics[width=\columnwidth/100*69]{images/screenshot-image-gallery.png}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=\columnwidth/100*77]{images/screenshot-image-list.png}
\end{figure}
...
\begin{figure}
  ...
  \todo[inline]{change graphic with self created one}
\end{figure}
