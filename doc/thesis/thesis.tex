...
\subsubsection{Editoren für Werte}
...
Da es an allen Stellen, bei denen in SQL Werte verglichen oder ausgegeben werden, möglich ist, diese durch Funktionen zu verändern oder durch Ausdrücke zu berechnen, wird allerdings ein Rückgriff auf freie Ausdrücke vorgesehen werden müssen. Es wird kaum möglich sein, den vollen Umfang aller denkbaren Funktionen bereitzustellen und spätestens geschachtelte Ausdrücke können sehr schnell enorm kompliziert werden.
