...
\warning{Der Verzicht auf die technischen Hintergründe der Implementierung soll dieses Kapitel auch für ``normale'' Informatiklehrer verständlich halten, ohne Sie gleich mit den ``unwichtigen'' Details der Realisierung zu erschlagen. Die Planung konkreter Umsetzungsstrategien, inklusive einer Erläuterung der notwendigen Schnittstellen, werden in Kapitel \ref{sec:implementation-analysis}~\nameref{sec:implementation-analysis} besprochen.}
