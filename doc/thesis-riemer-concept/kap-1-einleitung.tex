...
\warning[Hinweis]{Der im Rahmen dieser Thesis fertiggestellte Stand des Prototypen kann unter \href{http://blattwerkzeug.de}{\texttt{blattwerkzeug.de}} ausprobiert werden. Um nur einen kurzen Blick auf das vorläufige Arbeitsergebnis zu werfen, ist also keine lokale Installation notwendig. Da zum jetzigen Zeitpunkt allerdings noch keine Registrierung von Endanwendern implementiert worden ist, gestaltet sich der Zugriffsschutz ein wenig unbeholfen: Jedes Projekt dort verfügt über einen Testbenutzer namens \texttt{user} mit einem gleichlautenden Passwort. Dieser wird bei nur Speichervorgängen abgefragt, lesender Zugriff und lokale Veränderungen sind auch ohne Passwortabfrage möglich.}
