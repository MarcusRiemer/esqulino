...
\warning[Hinweis]{Lesern mit einer eher ergebnisorientierten Herangehensweise sei an dieser Stelle zunächst ein Blick in den Anhang \fullref{sec:project-examples} empfohlen. Dort werden einige beispielhafte Projekte gezeigt, die mit \idename{} umgesetzt worden sind.}
