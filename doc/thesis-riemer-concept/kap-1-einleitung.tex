...
Kapitel \fullref{sec:conclusion} zieht dann Bilanz und wagt einen Ausblick: Welche Ziele wurden noch nicht erreicht, an welchen Stellen lohnt sich die Weiterentwicklung? Die Entwicklung von \idename{} soll nicht mit der Fertigstellung dieser Thesis eingestellt werden, sondern in einer Kooperation zwischen der Fachhochschule Wedel und der CAU Kiel weiter ausgebaut werden. Das ambitionierte Fernziel ist ein Stand, der sich für den regelmäßige Einsatz im Unterricht eignet.
