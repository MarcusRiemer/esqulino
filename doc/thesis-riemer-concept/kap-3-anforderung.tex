...
\subsubsection{Wieviel Vorschau ist notwendig?}
...
Für \idename{} werden daher die folgenden möglichen Ansätze zunächst auf dem beschriebenen Koordinatensystem eingeordnet und dann diskutiert. Dabei ist Drag \& Drop als vornehmliches Bedienparadigma gesetzt, sofern die Beschreibung dies nicht explizit abspricht.

\begin{description}
\item[Vordefinierte Seiten für standarisierte Einsatzzwecke] \hfill \\
  Gedacht für Entwickler, die mit \idename{} einfach nur eine generische Oberfläche für einen Datenbestand erzeugen möchten. Layout und verfügbare Elemente sind dabei vordefiniert, es können lediglich an vorgesehenen Stellen Abfragen eingebunden oder konstante Texte hinterlegt werden.
