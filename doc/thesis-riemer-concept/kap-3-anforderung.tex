...
Für \idename{} werden daher die folgenden Ansätze auf dem beschriebenen Koordinatensystem ungefähr verordnet und deren individuelle Vor- und Nachteile diskutiert. Drag \& Drop als vornehmliches Bedienparadigma ist dabei für alle Varianten gesetzt, sofern die Beschreibung dies nicht explizit abspricht.
...
\begin{description}
\item[\circled{1} Vordefinierte Seiten für standarisierte Einsatzzwecke] \hfill \\
...
\item[\circled{5} Ausschließlich Quelltext] \hfill \\
