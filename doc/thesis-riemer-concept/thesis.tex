...
\item \fullref{sec:introduction} ist vollständig.
...
\item \fullref{sec:conclusion} ist vollständig.
\item \fullref{sec:project-examples} ist vollständig.
\end{itemize}
...
\item Anhang \fullref{sec:project-examples} ist fertig.
\end{itemize}
