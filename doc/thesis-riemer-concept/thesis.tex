...
\item \fullref{sec:requirements} fasert bei \fullref{sec:drag-drop-ui-editor} sehr abrupt aus, genau da ist noch Baustelle.
\item \fullref{sec:implementation-analysis} kann bis \fullref{sec:data-model-query} gelesen werden, dort ist aktuell einfach Schluss.
\end{itemize}
