...
Zu denen gehören die Nutzer (/projects/<id>/users), die am Projekt arbeiten und deren Freunde (/users/<id>/friends) (siehe \fullref{basics:rest:data-fetching}).
...
\begin{description}
    ...
    In \fullref{basics:rest:data-fetching} muss für jeden Nutzer eines Projektes, erfragt werden welche Freunde dieser hat.
