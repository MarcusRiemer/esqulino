...
Jede Zeile dieser Tabelle stellt also ein bestimmtes "Projekt" mit den ind \fullref{sec:requirements:example:interface} aufgeführten Feldern dar.
...
Der Server hat nun die Fähigkeit auf eine Anfrage nach allen Projekten unter Gewährlöesitung der Typsicherheit zu reagieren.
