...
Das aufgeführte Listing~\fullref{fig:basics:graphql:5} verkörpert eine GraphQL Query mit dem Bezeichner \emph{Projects},
...
Das passendes Schema dazu sieht folgendermaßen aus (siehe Listing~\fullref{fig:basics:jsonschema:2}).
...
Nehmen wir an ein Entwickler hat ein fehlerhaftes Projekt wie folgt erstellt (siehe Listing~\fullref{fig:basics:jsonschema:2}).
