...
\copyrightyear{2022}
\acmYear{2022}
\setcopyright{acmlicensed}\acmConference[CSERC '22]{The 11th Computer Science Education Research Conference}{November 21, 2022}{Leiden, Netherlands}
\acmBooktitle{The 11th Computer Science Education Research Conference (CSERC '22), November 21, 2022, Leiden, Netherlands}
\acmPrice{15.00}
\acmDOI{10.1145/3569173.3569174}
\acmISBN{978-1-4503-9747-6/22/11}
...
\keywords{language specification, block editor}
...
% Faked two column layout for listings
% I gave up to properly define a correct listing environment
% that could use minipages ...
