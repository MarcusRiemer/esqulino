...
describe('Shared: World', () => {
  ...
  it('shouldn\'t let truck turn left', () => {
    ...
    expect(() => world.command(Command.goForward)).toThrow(new StrayedOffTheRoadError());
  });
...
describe('Shared: Truck', () => {
  ...
  it('should know the facing direction after move', () => {
    ...
    expect(truck.facingDirectionAfterMove).toEqual(DirectionUtil.turn(Direction.West, TurnDirection.Left));
    truck.turn(TurnDirection.Right);
    expect(truck.facingDirectionAfterMove).toEqual(DirectionUtil.turn(Direction.West, TurnDirection.Right));
...
describe('Shared: Tile', () => {
  ...
  it('should have right curve turn direction', () => {
    expect(tileNE.curveTurnDirection(Direction.South)).toEqual(TurnDirection.Left);
    expect(tileNE.curveTurnDirection(Direction.West)).toEqual(TurnDirection.Right);
  });
  ...
  it('should return the right traffic lights', () => {
    ...
    const tileTL = new Tile(position, TileOpening.N | TileOpening.E | TileOpening.S | TileOpening.W, [], null, tl);
...
describe('Shared: DirectionUtil', () => {
  ...
  it('should convert to TileOpening', () => {
    expect(DirectionUtil.toTileOpening(Direction.North)).toEqual(TileOpening.North);
    expect(DirectionUtil.toTileOpening(Direction.East)).toEqual(TileOpening.East);
    expect(DirectionUtil.toTileOpening(Direction.South)).toEqual(TileOpening.South);
    expect(DirectionUtil.toTileOpening(Direction.West)).toEqual(TileOpening.West);
  });
  ...
  it('shouldn\'t take turns', () => {
    expect(DirectionUtil.turn(Direction.North, TurnDirection.Straight)).toEqual(Direction.North);
    expect(DirectionUtil.turn(Direction.East, TurnDirection.Straight)).toEqual(Direction.East);
    expect(DirectionUtil.turn(Direction.South, TurnDirection.Straight)).toEqual(Direction.South);
    expect(DirectionUtil.turn(Direction.West, TurnDirection.Straight)).toEqual(Direction.West);
  });

  it('should take left turns', () => {
    expect(DirectionUtil.turn(Direction.North, TurnDirection.Left)).toEqual(Direction.West);
    expect(DirectionUtil.turn(Direction.East, TurnDirection.Left)).toEqual(Direction.North);
    expect(DirectionUtil.turn(Direction.South, TurnDirection.Left)).toEqual(Direction.East);
    expect(DirectionUtil.turn(Direction.West, TurnDirection.Left)).toEqual(Direction.South);
  });

  it('should take right turns', () => {
    expect(DirectionUtil.turn(Direction.North, TurnDirection.Right)).toEqual(Direction.East);
    expect(DirectionUtil.turn(Direction.East, TurnDirection.Right)).toEqual(Direction.South);
    expect(DirectionUtil.turn(Direction.South, TurnDirection.Right)).toEqual(Direction.West);
    expect(DirectionUtil.turn(Direction.West, TurnDirection.Right)).toEqual(Direction.North);
  });
});
