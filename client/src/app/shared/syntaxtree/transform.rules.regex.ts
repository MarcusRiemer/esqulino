...
export const regexTranformRules: T.TransformRule[] = [
  /** RULE 1: The root nodes should always be an invis-container node.
  ...
  /** RULE 2: Char nodes should be single valued.
  ...
  /** RULE 4: Merging of immediate sibling invis-container nodes
