import { GrammarDocument, NodeAttributeDescription, } from './grammar.description';
import { getFullQualifiedAttributes } from './grammar-util';

// All type literals that are used for visuals only
const VISUAL_TYPES: Set<NodeAttributeDescription["type"]> = new Set(["terminal", "container"]);
