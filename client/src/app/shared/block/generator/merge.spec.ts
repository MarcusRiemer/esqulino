...
describe(`Merging TypeInstructions`, () => {
  ...
  it(`Unrelated grammars`, () => {
    expect(mergeTypeInstructions({ g1: {} }, { g2: {} })).toEqual({
      g1: {},
      g2: {},
    });
  });
  ...
  it(`Related grammars with unrelated types`, () => {
    expect(
      mergeTypeInstructions({ g1: { t1: {} } }, { g1: { t2: {} } })
    ).toEqual({
      g1: { t1: {}, t2: {} },
    });
  });
  ...
  it(`Unrelated attributes`, () => {
    expect(
      mergeTypeInstructions(
        { g1: { t1: { attributes: { a1: { between: "1" } } } } },
        { g1: { t1: { attributes: { a2: { between: "2" } } } } }
      )
    ).toEqual({
      g1: {
        t1: { attributes: { a1: { between: "1" }, a2: { between: "2" } } },
      },
    });
  });
  ...
  it(`Clashing and unrelated attributes`, () => {
    expect(
      mergeTypeInstructions(
        {
          g1: {
            t1: { attributes: { a1: { between: "1", propReadOnly: true } } },
          },
        },
        {
          g1: {
            t1: {
              attributes: {
                a1: { between: "2", generateErrorIndicator: "start" },
              },
            },
          },
        }
