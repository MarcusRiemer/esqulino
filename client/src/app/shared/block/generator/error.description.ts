...
export type GeneratorError = ErrorInvalidInstructions | ErrorValueForUnknownParameter | ErrorParameterMissingValue | ErrorReferenceToUnknownParameter | ErrorUnexpected;
