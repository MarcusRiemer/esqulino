...
describe("ChangeLanguageComponent", () => {
  async function createComponent(localeId: string) {
    await TestBed.configureTestingModule({
      ...
      declarations: [ChangeLanguageComponent, JavascriptRequiredComponent],
    }).compileComponents();
  ...
  it('Should provide correct URLs from "de"', async () => {
    ...
    expect(t.component.urlForLanguage("de")).toEqual(
      "//" + environment.canonicalHost
    );
    expect(t.component.urlForLanguage("en")).toEqual(
      "//en." + environment.canonicalHost
    );
