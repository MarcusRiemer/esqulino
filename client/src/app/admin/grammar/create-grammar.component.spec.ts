...
import {LanguageService, ServerApiService, ToolbarService} from '../../shared';
...
describe('CreateGrammarComponent', () => {
    ...
    it(`create grammar`, async () => {
        ...
        const nameInput: HTMLInputElement = t.element.querySelector('input[data-spec=nameInput]');
        const plSelect: HTMLSelectElement = t.element.querySelector('select[data-spec=programmingLanguageSelect]');
        const createButton: HTMLButtonElement = t.element.querySelector("button[data-spec=submit]");
