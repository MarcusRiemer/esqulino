...
/** Autogenerated input type of DeepCopyProject */
export type DeepCopyProjectInput = {
  projectId: Scalars["ID"];
  slug: Scalars["String"];
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars["String"]>;
...
/** Autogenerated return type of DeepCopyProject */
export type DeepCopyProjectPayload = {
  __typename?: "DeepCopyProjectPayload";
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars["String"]>;
  project?: Maybe<Project>;
};
...
export type Mutation = {
  ...
  deepCopyProject?: Maybe<DeepCopyProjectPayload>;
...
export type MutationDeepCopyProjectArgs = {
  input: DeepCopyProjectInput;
};
...
export type DeepCopyProjectMutationVariables = Exact<{
  projectId: Scalars["ID"];
  slug: Scalars["String"];
}>;

export type DeepCopyProjectMutation = { __typename?: "Mutation" } & {
  deepCopyProject?: Maybe<
    { __typename?: "DeepCopyProjectPayload" } & {
      project?: Maybe<
        { __typename?: "Project" } & Pick<
          Project,
...
export const DeepCopyProjectDocument = gql`
  mutation DeepCopyProject($projectId: ID!, $slug: String!) {
    deepCopyProject(input: { projectId: $projectId, slug: $slug }) {
      project {
        id
        slug
        name
...
export class DeepCopyProjectGQL extends Apollo.Mutation<
  DeepCopyProjectMutation,
  DeepCopyProjectMutationVariables
> {
  document = DeepCopyProjectDocument;
