...
export type AssignmentRequiredCodeResource = {
  ...
  >;
  assignmentTemplateCodeResource?: Maybe<AssignmentTemplateCodeResource>;
...
/** Autogenerated input type of CreateCourseParticipation */
export type CreateCourseParticipationInput = {
  solutionProjectId: Scalars["ID"];
  userIds: Array<Scalars["ID"]>;
  slug?: Maybe<Scalars["String"]>;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars["String"]>;
...
/** Autogenerated return type of CreateCourseParticipation */
export type CreateCourseParticipationPayload = {
  __typename?: "CreateCourseParticipationPayload";
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars["String"]>;
  project?: Maybe<Project>;
};
...
export type Mutation = {
  ...
  createCourseParticipation?: Maybe<CreateCourseParticipationPayload>;
...
export type MutationCreateCourseParticipationArgs = {
  input: CreateCourseParticipationInput;
};
...
export type Project = {
  ...
  assignmentsProjectCourseParticipations?: Maybe<
    Array<ProjectCourseParticipation>
  >;
  assignmentsProjects?: Maybe<Array<Project>>;
  ...
  slug?: Maybe<Scalars["String"]>;
  solutionProject?: Maybe<Project>;
  solutionProjectCourseParticipation?: Maybe<ProjectCourseParticipation>;
  updatedAt: Scalars["ISO8601DateTime"];
  user?: Maybe<User>;
  userId?: Maybe<Scalars["ID"]>;
};
...
export type CreateCourseParticipationMutationVariables = Exact<{
  solutionProjectId: Scalars["ID"];
  userIds: Array<Scalars["ID"]> | Scalars["ID"];
  slug?: Maybe<Scalars["String"]>;
}>;

export type CreateCourseParticipationMutation = { __typename?: "Mutation" } & {
  createCourseParticipation?: Maybe<
    { __typename?: "CreateCourseParticipationPayload" } & {
      project?: Maybe<
...
export const CreateCourseParticipationDocument = gql`
  mutation CreateCourseParticipation(
    $solutionProjectId: ID!
    $userIds: [ID!]!
    $slug: String
  ) {
    createCourseParticipation(
      input: {
        solutionProjectId: $solutionProjectId
        userIds: $userIds
        slug: $slug
      }
    ) {
...
export class CreateCourseParticipationGQL extends Apollo.Mutation<
  CreateCourseParticipationMutation,
  CreateCourseParticipationMutationVariables
> {
  document = CreateCourseParticipationDocument;
