...
/** Autogenerated input type of CreateCodeResource */
export type CreateCodeResourceInput = {
  name: Scalars["String"];
  projectId: Scalars["ID"];
  blockLanguageId: Scalars["ID"];
  programmingLanguageId: Scalars["ID"];
...
/** Autogenerated return type of CreateCodeResource */
export type CreateCodeResourcePayload = {
  __typename?: "CreateCodeResourcePayload";
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars["String"]>;
...
export type CreateProgrammingLanguagePayload = {
  ...
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars["String"]>;
  grammarCodeResourceId: Scalars["ID"];
...
export type Mutation = {
  ...
  createCodeResource?: Maybe<CreateCodeResourcePayload>;
...
export type CreateProgrammingLanguageMutation = { __typename?: "Mutation" } & {
  createProgrammingLanguage?: Maybe<
    { __typename?: "CreateProgrammingLanguagePayload" } & Pick<
      CreateProgrammingLanguagePayload,
      "grammarId" | "grammarCodeResourceId"
    >
  >;
};
...
export const CreateProgrammingLanguageDocument = gql`
  mutation CreateProgrammingLanguage($projectId: ID!, $languageName: String!) {
    createProgrammingLanguage(
      input: { projectId: $projectId, languageName: $languageName }
    ) {
      grammarId
      grammarCodeResourceId
    }
  }
`;
