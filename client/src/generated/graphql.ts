...
/** Autogenerated input type of CreateProgrammingLanguageProject */
export type CreateProgrammingLanguageProjectInput = {
...
/** Autogenerated return type of CreateProgrammingLanguageProject */
export type CreateProgrammingLanguageProjectPayload = {
  __typename?: "CreateProgrammingLanguageProjectPayload";
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars["String"]>;
  id?: Maybe<Scalars["ID"]>;
};
...
export type Mutation = {
  ...
  createProgrammingLanguageProject?: Maybe<
    CreateProgrammingLanguageProjectPayload
  >;
...
export type MutationCreateProgrammingLanguageProjectArgs = {
  input: CreateProgrammingLanguageProjectInput;
};
...
export type StoreProjectPayload = {
  ...
  affectedIds?: Maybe<Array<Array<StoredSeed>>>;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars["String"]>;
  errors: Array<Scalars["String"]>;
};
...
export type CreateProgrammingLanguageProjectMutationVariables = Exact<{
  projectName: Scalars["String"];
  languageName: Scalars["String"];
  description: Scalars["String"];
}>;

export type CreateProgrammingLanguageProjectMutation = {
  __typename?: "Mutation";
} & {
  createProgrammingLanguageProject?: Maybe<
    { __typename?: "CreateProgrammingLanguageProjectPayload" } & Pick<
      CreateProgrammingLanguageProjectPayload,
      "id"
    >
  >;
...
export type StoreProjectSeedMutation = { __typename?: "Mutation" } & {
  storeProjectSeed?: Maybe<
    { __typename?: "StoreProjectPayload" } & {
      affectedIds?: Maybe<
        Array<
          Array<{ __typename?: "StoredSeed" } & Pick<StoredSeed, "id" | "type">>
        >
      >;
    }
  >;
...
export const CreateProgrammingLanguageProjectDocument = gql`
  mutation CreateProgrammingLanguageProject(
    $projectName: String!
    $languageName: String!
    $description: String!
  ) {
    createProgrammingLanguageProject(
      input: {
...
export class CreateProgrammingLanguageProjectGQL extends Apollo.Mutation<
  CreateProgrammingLanguageProjectMutation,
  CreateProgrammingLanguageProjectMutationVariables
> {
  document = CreateProgrammingLanguageProjectDocument;
