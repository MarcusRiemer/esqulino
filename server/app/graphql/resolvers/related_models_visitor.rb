module Resolvers
  ...
  class RelatedModelsVisitor < GraphQL::Language::Visitor
    ...
    def on_field(node, parent)
      ...
      if !parent.name.nil? and @stack.last != parent
    ...
    def stack_model_attributes(stack)
      ...
      stack.each do |stack_node|
        ...
        if model_attribute and !matching_association
          ...
          raise "Unknown attribute #{stack_node.name} in model association stack: #{stack_names}"
