...
RSpec.describe ProjectDatabase, type: :model do
  ...
  describe 'execute_sql' do
    ...
    it 'Truncates too large result sets' do
      res = @db.execute_sql('SELECT * FROM numbers a, numbers b', {}, true, 10, 100)
    ...
    it 'Delivers entirely fitting result sets' do
      res = @db.execute_sql('SELECT * FROM numbers a, numbers b LIMIT 10', {}, true, 10, 100)
    ...
    it 'Delivers partially fitting result sets' do
      res = @db.execute_sql('SELECT * FROM numbers a, numbers b LIMIT 20', {}, true, 10, 100)
