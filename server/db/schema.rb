...
ActiveRecord::Schema.define(version: 20_210_930_083_329) do
  ...
  create_table 'code_resource_references', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[origin_id target_id], name: 'code_resource_references_unique', unique: true
  ...
  create_table 'grammar_references', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[origin_id target_id], name: 'grammar_references_unique', unique: true
  ...
  create_table 'project_uses_block_languages', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[project_id block_language_id], name: 'block_languages_projects_unique', unique: true
